...
$this->title = 'Detalle de Memoria RAM';
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header bg-info text-white text-center">
                    ...
                    <p class="mb-0 mt-2">ID: <?= Html::encode($model->idRAM) ?> | <?= Html::encode($model->MARCA . ' ' . $model->CAPACIDAD) ?> GB</p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= Html::encode($model->CAPACIDAD ?? '-') ?> GB" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Tipo DDR</label>
                                <input type="text" class="form-control" value="<?= Html::encode($model->TIPO_DDR ?? '-') ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Interfaz</label>
                                <input type="text" class="form-control" value="<?= Html::encode($model->TIPO_INTERFAZ ?? '-') ?>" readonly>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                        <?= Html::a('<i class="fas fa-arrow-left me-2"></i>Volver al Listado', ['site/ram-listar'], ['class' => 'btn btn-secondary']) ?>
                    </div>
                </div>
            </div>
        </div>
