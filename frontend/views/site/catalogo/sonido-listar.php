...
$this->title = 'Catálogo de Equipos de Sonido';
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-danger text-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h1 class="h3 mb-0 fw-bold">Gestión de Catálogos - Equipos de Sonido</h1>
                            <small class="opacity-75">Solo equipos de sonido creados desde el formulario rápido (catálogo)</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <p class="mb-0">
                            <i class="fas fa-infinity me-1"></i> <strong>Reutilización infinita:</strong> Puedes usar estos equipos de sonido cuantas veces necesites sin que se agoten.<br>
                    ...
                    <?php else: ?>
                        ...
                        <?php if (empty($sonidos)): ?>
                            <div class="alert alert-warning text-center" role="alert">
                                <h4><i class="fas fa-exclamation-triangle me-2"></i>No hay equipos de sonido en el catálogo</h4>
                                <p class="mb-3">Aún no has agregado equipos de sonido usando el formulario rápido.</p>
                                <a href="<?= Url::to(['site/equipo-de-sonido', 'simple' => 1]) ?>" class="btn btn-primary">
                                    <i class="fas fa-plus me-2"></i>Agregar Primer Equipo de Sonido al Catálogo
                                </a>
                            </div>
                        <?php else: ?>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6 text-end">
                                    <button type="button" class="btn btn-dark" id="btn-eliminar-seleccionados" onclick="eliminarSeleccionados()" disabled>
                                        ...
                                        <div class="card h-100 shadow-sm border-danger">
                                            <div class="card-body">
                                                ...
                                                <div class="form-check position-absolute" style="top: 10px; left: 10px; z-index: 1;">
                                                    <input type="checkbox" name="sonido_ids[]" class="form-check-input item-checkbox" value="<?= $sonido->idSonido ?>">
                                                </div>
                                                
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div class="flex-grow-1 ps-4">
                                                        <h6 class="card-title mb-1 text-danger fw-bold">
                                                            <i class="fas fa-volume-up me-2"></i><?= Html::encode($sonido->MARCA) ?>
                                                        </h6>
                                                        <p class="card-text mb-2 text-dark fw-medium"><?= Html::encode($sonido->MODELO) ?></p>
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <span class="badge bg-danger ms-1"><?= Html::encode($sonido->ESTADO) ?></span>
                                                        </div>

                                                        <!-- Tipo -->
                                                        <small class="text-muted d-block">
                                                            <i class="fas fa-music me-1"></i>Tipo: <?= Html::encode($sonido->TIPO) ?>
                                                        </small>

                                                        <!-- Número de inventario -->
                                                        <small class="text-muted">
                                                            <i class="fas fa-tag me-1"></i><?= Html::encode($sonido->NUMERO_INVENTARIO) ?>
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <?= Html::a('<i class="fas fa-eye me-2"></i>Ver Detalles', ['sonido-ver', 'id' => $sonido->idSonido], ['class' => 'dropdown-item']) ?>
                                                            </li>
                                                            <li>
                                                                <?= Html::a('<i class="fas fa-edit me-2"></i>Editar', ['sonido-editar', 'id' => $sonido->idSonido], ['class' => 'dropdown-item']) ?>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a href="javascript:void(0)" onclick="eliminarItem(<?= $sonido->idSonido ?>, '<?= Html::encode($sonido->MARCA . ' ' . $sonido->MODELO) ?>')" class="dropdown-item text-danger">
                                            ...
                                            <div class="card-footer bg-light text-muted">
                                                <small>
                                                    ...
                                                    Agregado: <?= Yii::$app->formatter->asDatetime($sonido->fecha_creacion ?? 'now', 'short') ?>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="<?= Url::to(['site/equipo-de-sonido', 'simple' => 1]) ?>" class="btn btn-danger">
                                <i class="fas fa-plus me-2"></i>Agregar Nuevo al Catálogo
                            </a>
                            <a href="<?= Url::to(['site/sonido-listar']) ?>" class="btn btn-outline-danger">
                                <i class="fas fa-list me-2"></i>Ver Todos los Equipos de Sonido
                            </a>
                        </div>
                    </div>
                </div>
...
$this->registerJs(<<<JS
    ...
    function exportarPDF() {
        ...
        doc.setFontSize(16);
        doc.text('Catálogo de Equipos de Sonido', 14, 20);
        doc.setFontSize(10);
        doc.text('Fecha: ' + new Date().toLocaleDateString(), 14, 28);
        
        const tableData = [];
        document.querySelectorAll('.card.border-danger').forEach(function(card) {
        ...
        doc.save('catalogo_equipos_sonido.pdf');
    }
