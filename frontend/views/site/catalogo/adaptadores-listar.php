...
/** @var array $adaptadores */
/** @var string|null $error */

$this->title = 'Catálogo de Adaptadores';
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-dark text-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h1 class="h3 mb-0 fw-bold">Gestión de Catálogos - Adaptadores</h1>
                            <small class="opacity-75">Solo adaptadores creados desde el formulario rápido (catálogo)</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <p class="mb-0">
                            <i class="fas fa-infinity me-1"></i> <strong>Reutilización infinita:</strong> Puedes usar estos adaptadores cuantas veces necesites sin que se agoten.<br>
                    ...
                    <?php else: ?>
                        ...
                        <?php if (empty($adaptadores)): ?>
                            <div class="alert alert-warning text-center" role="alert">
                                <h4><i class="fas fa-exclamation-triangle me-2"></i>No hay adaptadores en el catálogo</h4>
                                <p class="mb-3">Aún no has agregado adaptadores usando el formulario rápido.</p>
                                <a href="<?= Url::to(['site/adaptadores', 'simple' => 1]) ?>" class="btn btn-primary">
                                    <i class="fas fa-plus me-2"></i>Agregar Primer Adaptador al Catálogo
                                </a>
                            </div>
                        <?php else: ?>
                                        ...
                                        <div class="card h-100 shadow-sm border-dark">
                                            <div class="card-body">
                                                ...
                                                <div class="form-check position-absolute" style="top: 10px; left: 10px; z-index: 1;">
                                                    <input type="checkbox" name="adaptador_ids[]" class="form-check-input item-checkbox" value="<?= $adaptador->idAdaptador ?>">
                                                </div>
                                                
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div class="flex-grow-1 ps-4">
                                                        <h6 class="card-title mb-1 text-dark fw-bold">
                                                            <i class="fas fa-plug me-2"></i><?= Html::encode($adaptador->MARCA) ?>
                                                        </h6>
                                                        <p class="card-text mb-2 text-dark fw-medium"><?= Html::encode($adaptador->MODELO) ?></p>
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <span class="badge bg-dark ms-1"><?= Html::encode($adaptador->ESTADO) ?></span>
                                                        </div>

                                                        <!-- Tipo -->
                                                        <small class="text-muted d-block">
                                                            <i class="fas fa-cog me-1"></i>Tipo: <?= Html::encode($adaptador->TIPO) ?>
                                                        </small>

                                                        <!-- Número de inventario -->
                                                        <small class="text-muted">
                                                            <i class="fas fa-tag me-1"></i><?= Html::encode($adaptador->NUMERO_INVENTARIO) ?>
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <?= Html::a('<i class="fas fa-eye me-2"></i>Ver Detalles', ['adaptador-ver', 'id' => $adaptador->idAdaptador], ['class' => 'dropdown-item']) ?>
                                                            </li>
                                                            <li>
                                                                <?= Html::a('<i class="fas fa-edit me-2"></i>Editar', ['adaptador-editar', 'id' => $adaptador->idAdaptador], ['class' => 'dropdown-item']) ?>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a href="javascript:void(0)" onclick="eliminarItem(<?= $adaptador->idAdaptador ?>, '<?= Html::encode($adaptador->MARCA . ' ' . $adaptador->MODELO) ?>')" class="dropdown-item text-danger">
                                            ...
                                            <div class="card-footer bg-light text-muted">
                                                <small>
                                                    ...
                                                    Agregado: <?= Yii::$app->formatter->asDatetime($adaptador->fecha_creacion ?? 'now', 'short') ?>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 text-end">
                            <a href="<?= Url::to(['site/adaptadores', 'simple' => 1]) ?>" class="btn btn-dark">
                                <i class="fas fa-plus me-2"></i>Agregar Nuevo al Catálogo
                            </a>
                            <a href="<?= Url::to(['site/adaptadores-listar']) ?>" class="btn btn-outline-dark">
                                <i class="fas fa-list me-2"></i>Ver Todos los Adaptadores
                            </a>
                        </div>
                    </div>
                </div>
...
$this->registerJs(<<<JS
    ...
    function exportarPDF() {
        ...
        doc.setFontSize(16);
        doc.text('Catálogo de Adaptadores', 14, 20);
        doc.setFontSize(10);
        ...
        doc.save('catalogo_adaptadores.pdf');
    }
