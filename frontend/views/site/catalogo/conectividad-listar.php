...
$this->title = 'Catálogo de Conectividad';
            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-primary text-white py-3">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h1 class="h3 mb-0 fw-bold">Gestión de Catálogos - Conectividad</h1>
                            <small class="opacity-75">Solo equipos de conectividad creados desde el formulario rápido (catálogo)</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info alert-dismissible fade show" role="alert">
                        ...
                        <p class="mb-0">
                            <i class="fas fa-infinity me-1"></i> <strong>Reutilización infinita:</strong> Puedes usar estos equipos de conectividad cuantas veces necesites sin que se agoten.<br>
                    ...
                    <?php else: ?>
                        ...
                        <?php if (empty($conectividades)): ?>
                            <div class="alert alert-warning text-center" role="alert">
                                <h4><i class="fas fa-exclamation-triangle me-2"></i>No hay equipos de conectividad en el catálogo</h4>
                                <p class="mb-3">Aún no has agregado equipos de conectividad usando el formulario rápido.</p>
                                <a href="<?= Url::to(['site/conectividad', 'simple' => 1]) ?>" class="btn btn-primary">
                                    <i class="fas fa-plus me-2"></i>Agregar Primer Equipo de Conectividad al Catálogo
                                </a>
                            </div>
                        <?php else: ?>
                            ...
                            <!-- Lista de Equipos de Conectividad -->
                            <div class="row g-3">
                                        ...
                                        <div class="card h-100 shadow-sm border-primary">
                                            <div class="card-body">
                                                ...
                                                <div class="form-check position-absolute" style="top: 10px; left: 10px; z-index: 1;">
                                                    <input type="checkbox" name="conectividad_ids[]" class="form-check-input item-checkbox" value="<?= $conectividad->idCONECTIVIDAD ?>">
                                                </div>
                                                
                                                <div class="d-flex align-items-start justify-content-between">
                                                    <div class="flex-grow-1 ps-4">
                                                        <h6 class="card-title mb-1 text-primary fw-bold">
                                                            <i class="fas fa-network-wired me-2"></i><?= Html::encode($conectividad->MARCA) ?>
                                                        </h6>
                                                        <p class="card-text mb-2 text-dark fw-medium"><?= Html::encode($conectividad->MODELO) ?></p>
                                                        ...
                                                        <div class="mb-2">
                                                            ...
                                                            <span class="badge bg-primary ms-1"><?= Html::encode($conectividad->Estado) ?></span>
                                                        </div>

                                                        <!-- Tipo -->
                                                        <small class="text-muted d-block">
                                                            <i class="fas fa-sitemap me-1"></i>Tipo: <?= Html::encode($conectividad->TIPO) ?>
                                                        </small>

                                                        <!-- Número de inventario -->
                                                        <small class="text-muted">
                                                            <i class="fas fa-tag me-1"></i><?= Html::encode($conectividad->NUMERO_INVENTARIO) ?>
                                                        </small>
                                                    </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            <li>
                                                                <?= Html::a('<i class="fas fa-eye me-2"></i>Ver Detalles', ['conectividad-ver', 'id' => $conectividad->idCONECTIVIDAD], ['class' => 'dropdown-item']) ?>
                                                            </li>
                                                            <li>
                                                                <?= Html::a('<i class="fas fa-edit me-2"></i>Editar', ['conectividad-editar', 'id' => $conectividad->idCONECTIVIDAD], ['class' => 'dropdown-item']) ?>
                                                            </li>
                                                            <li><hr class="dropdown-divider"></li>
                                                            <li>
                                                                <a href="javascript:void(0)" onclick="eliminarItem(<?= $conectividad->idCONECTIVIDAD ?>, '<?= Html::encode($conectividad->MARCA . ' ' . $conectividad->MODELO) ?>')" class="dropdown-item text-danger">
                                            ...
                                            <div class="card-footer bg-light text-muted">
                                                <small>
                                                    ...
                                                    Agregado: <?= Yii::$app->formatter->asDatetime($conectividad->fecha_creacion ?? 'now', 'short') ?>
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-md-6 text-end">
                            ...
                            <a href="<?= Url::to(['site/conectividad-listar']) ?>" class="btn btn-outline-primary">
                                <i class="fas fa-list me-2"></i>Ver Todos los Equipos de Conectividad
                            </a>
                        </div>
                    </div>
                </div>
...
$this->registerJs(<<<JS
    ...
    function eliminarSeleccionados() {
        ...
        alert('❌ PROTEGIDO: Los items del catálogo NO se pueden eliminar.\n\n✅ Son reutilizables infinitamente.\n\nEstos ' + seleccionados.length + ' equipos de conectividad están protegidos y disponibles para uso ilimitado.');
    }
    window.eliminarSeleccionados = eliminarSeleccionados;

    function eliminarItem(id, nombre) {
        alert('❌ PROTEGIDO: Los items del catálogo NO se pueden eliminar.\n\n✅ Son reutilizables infinitamente.\n\nPuedes usar este equipo de conectividad cuantas veces quieras sin que se agote.');
    }
    ...
    function exportarPDF() {
        ...
        doc.setFontSize(16);
        doc.text('Catálogo de Conectividad', 14, 20);
        doc.setFontSize(10);
        ...
        doc.save('catalogo_conectividad.pdf');
    }
