...
/* @var $model frontend\models\adaptador */

$this->title = 'Detalle de Adaptador';
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header bg-danger text-white text-center">
                    ...
                    <p class="mb-0 mt-2">ID: <?= Html::encode($model->idAdaptador) ?> | <?= Html::encode($model->MARCA . ' ' . $model->MODELO) ?></p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="form-label fw-bold">Amperaje</label>
                                <input type="text" class="form-control" value="<?= Html::encode($model->AMPERAJE ?? '-') ?>" readonly>
                            </div>
                            <div class="mb-3">
                                <label class="form-label fw-bold">Potencia</label>
                                <input type="text" class="form-control" value="<?= Html::encode($model->POTENCIA ?? '-') ?>" readonly>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                        <?= Html::a('<i class="fas fa-arrow-left me-2"></i>Volver al Listado', ['site/adaptador-listar'], ['class' => 'btn btn-secondary']) ?>
                    </div>
                </div>
            </div>
        </div>
