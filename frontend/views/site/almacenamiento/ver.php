...
$this->title = 'Detalle de Almacenamiento';
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header text-white text-center" style="background: linear-gradient(135deg, #6f42c1 0%, #e83e8c 100%);">
                    ...
                    <p class="mb-0 mt-2">ID: <?= Html::encode($model->idAlmacenamiento) ?> | <?= Html::encode($model->MARCA . ' ' . $model->MODELO) ?></p>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?= Html::encode($model->INTERFAZ ?? '-') ?>" readonly>
                            </div>
                            <div class="mb-3">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                        <?= Html::a('<i class="fas fa-arrow-left me-2"></i>Volver al Listado', ['site/almacenamiento-listar'], ['class' => 'btn btn-secondary']) ?>
                    </div>
                </div>
            </div>
        </div>
