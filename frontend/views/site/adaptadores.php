...
$this->title = $modoSimplificado ? 'Agregar Adaptador (Catálogo)' : 'Agregar Adaptador';
        ...
        <div class="col-md-10">
            ...
            <?php if ($modoSimplificado): ?>
                ...
                <div class="alert alert-info" role="alert">
                    ...
                    Este adaptador se guardará SOLO con marca y modelo para uso en catálogo.
                </div>
                ...
                <div class="d-grid gap-2 d-md-flex justify-content-md-center mt-4">
                    ...
                    <?= Html::a('<i class="fas fa-arrow-left me-2"></i>Volver', ['site/adaptadores-catalogo-listar'], ['class' => 'btn btn-secondary btn-lg']) ?>
                </div>
